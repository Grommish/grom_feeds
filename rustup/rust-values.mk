...
# RUSTFLAGS
RUSTFLAGS=-C linker=$(TARGET_CC_NOCACHE) -C ar=$(TARGET_AR) -Ctarget-feature=-crt-static

ifeq ($(CONFIG_USE_MUSL),y)
  # Force linking of the SSP library for musl
  ifdef CONFIG_PKG_CC_STACKPROTECTOR_REGULAR
    ifeq ($(strip $(PKG_SSP)),1)
      RUSTFLAGS+=-lssp_nonshared
    endif
  endif
...
CARGO := $(CARGO_PKG_CONFIG_VARS) $(CARGO_HOME)/bin/cargo
